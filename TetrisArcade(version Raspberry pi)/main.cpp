...
int main()
{
    ...
    sf::RenderWindow menuPrincipal(sf::VideoMode(1500, 950), "Menu");
    ...
    while(menuPrincipal.isOpen())
    {
        ...
        textlancerJeu.setString("Appuyer sur Start pour lancer le jeu");
        ...
        textVoirScore.setString("Appuyer sur Select pour quitter");
        ...
        {
            if(event.type == sf::Event::Closed || event.joystickButton.button == 3)
                menuPrincipal.close();
            ...
            if (event.joystickButton.button == 2)
            {
                ...
                while (jeuTetris.isOpen())
                {
                    ...
                    ///////////////////////// fin class fenetre principale ////////////////////////
                    ///Game Over///
                    if(!check())
                    {
                        std::cout << "Game Over" << std::endl;
                        jeuTetris.close();
                        sf::RenderWindow gameOver(sf::VideoMode(1500,950), "Game Over");
                        ...
                        textQuitter.setString("Appuyer sur Select pour quitter");
                        ...
                        while(gameOver.isOpen())
                        {
                            ...
                            {
                                if(eventClose.type == sf::Event::Closed || event.joystickButton.button == 3)
                                {
                                    gameOver.close();
                                }
                            }
